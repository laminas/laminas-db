...
{
    protected const QUERY_DELIMITER      = "\n;^";
    protected const FIXTURE_NAME_PATTERN = "#^\d+-.+\.sql$#";
    /** @var string */
                ...
                if (false === $result) {
                    ...
                    throw new Exception(sprintf(
                        ...
                        print_r([
                            ...
                            'errorInfo'   => $errorInfo,
                            'query_index' => $index,
                            'query'       => mb_strlen($query) > $maxFixtureLen ? mb_substr(
                                $query,
                                0,
                                $maxFixtureLen
                            ) . '...CUT...' : $query,
                            'fixture'     => mb_strlen($fixture) > $maxFixtureLen ? mb_substr(
                                $fixture,
                                0,
                                $maxFixtureLen
                            ) . '...CUT...' : $fixture,
