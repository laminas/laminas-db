...
class PgsqlTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mockConnection = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Pgsql\Connection', [[]], '', true, true, true, ['setDriver']);
    ...
    {
        $this->pgsql = new Pgsql([]);
        $mockStatement = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Pgsql\Statement', [], '', true, true, true, ['setDriver']);
    ...
    {
        $this->pgsql = new Pgsql([]);
        $mockStatement = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Pgsql\Result', [], '', true, true, true, ['setDriver']);
