...
class SqlsrvTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mockConnection = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Sqlsrv\Connection', [[]], '', true, true, true, ['setDriver']);
    ...
    {
        $this->sqlsrv = new Sqlsrv([]);
        $mockStatement = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Sqlsrv\Statement', [], '', true, true, true, ['setDriver']);
    ...
    {
        $this->sqlsrv = new Sqlsrv([]);
        $mockStatement = $this->getMockForAbstractClass('Laminas\Db\Adapter\Driver\Sqlsrv\Result', [], '', true, true, true, ['setDriver']);
