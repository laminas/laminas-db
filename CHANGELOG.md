...
- [zendframework/zend-db#157](https://github.com/zendframework/zend-db/pull/157) added support of `Laminas\Db\Sql\TableIdentifier` in DDL

- [zendframework/zend-db#345](https://github.com/zendframework/zend-db/pull/345) allow usage with laminas-hydrator v3

- [zendframework/zend-db#346](https://github.com/zendframework/zend-db/pull/346) adds support for PHP 7.3
